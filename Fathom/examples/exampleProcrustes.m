...
morph_scores = f_stnd(morph_scores);
% 
% Procrustes Analysis:
[m2,morph_scl,perform_scl,resid,prob,H] = f_procrustes(morph_scores(:,1:2),...
...
f_biplotPca2(morph_evects,1,0,mLabels);
f_biplotPca2(perform_evects(:,1:2)*H,1,0,pLabels);
box on;
