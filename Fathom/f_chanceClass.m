...
% success rate of a discriminant analysis is better that a null model that
% assigns group membership merely by chance. It provides the probability that
% observations will be classified to the correct group merely by chance and
